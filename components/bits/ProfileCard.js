...
<div class="p-4">
    ...
    <div class="text-center">
        <p class="text-2xl text-gray-800 dark:text-white m-0">
            Christian Claudeaux
        </p>
        <p class="text-xl text-gray-500 dark:text-gray-200 font-light mt-0 mb-1">
            Full Stack Developer
        </p>
        <p class="text-md text-center mx-auto text-gray-500 dark:text-gray-400 max-w-xs py-4 font-light my-1">
            Composer, Coder, Creator. Microsoft and open source web development Technology specialist <span><Link href={"/about"}>about.</Link></span>
        </p>
    </div>
    <div class="pt-8 flex border-t border-gray-200 w-44 mx-auto text-gray-500 items-center justify-between">
        ...
        <a href="https://stackoverflow.com/users/6723894/christian-a">
