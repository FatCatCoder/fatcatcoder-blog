...
export default function About() {
  ...
  return (
    ...
    <FadeInOut x={-20} delay={2}>
      <div className='bg-red-500 h-50 fixed bottom-0 w-100vw'>f</div>
      <section class="text-gray-600 body-font">
        <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          <img style={{objectFit: "cover", borderRadius: "50%", height: 350, width: 350}} width={350} height={350} src="sirfatcat.jpg" class="mb-10" alt="hero" />
          <div class="text-center lg:w-2/3 w-full">
            ...
            Every now and again Ill pick up a new interest such as microcontroller programing with arduino, wood working, or hacking at my espresso machine.
            </p>
                      ...
                      <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
                        <div class="flex flex-col lg:flex-row lg:justify-between items-center bg-gray-100 rounded-lg p-4 sm:p-8">
                          <div class="mb-4 sm:mb-8 lg:mb-0">
                            <h2 class="text-indigo-500 text-xl sm:text-2xl lg:text-3xl font-bold text-center lg:text-left">Hello, Lets chat.</h2>
                            <p class="text-gray-500 text-center lg:text-left">Send me a message</p>
                          </div>

                          <div class="flex flex-col items-center lg:items-end">
                            <form class="w-full max-w-md flex gap-2 mb-3">
                              <a onClick={() => { setIsShowing((isShowing) => !isShowing); setTimeout(() => setIsShowing((isShowing) => !isShowing), 2500); navigator.clipboard.writeText("christianclaudeaux@gmail.com");}} class="inline-block bg-indigo-500 hover:bg-indigo-600 active:bg-indigo-700 focus-visible:ring ring-indigo-300 text-white text-sm md:text-base font-semibold text-center rounded outline-none transition duration-100 px-8 py-2">Copy Email</a>
